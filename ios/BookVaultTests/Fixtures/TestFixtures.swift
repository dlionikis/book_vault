...
enum TestFixtures {
    ...
    static func makeBook(
        ...
        archiveStatus: BookVault.Book.ArchiveStatus = .available,
        publisherSummary: String? = "A test book description",
    ...
    static func makeLibraryBook(
        ...
        asin: String = "B00TEST123",
        title: String = "Test Book Title",
        archiveStatus: BookVault.LibraryBook.ArchiveStatus = .available,
        publisherSummary: String? = "A test book description",
        runtimeMinutes: Int? = 360,
        releaseDate: Date? = nil,
        publisher: String? = "Test Publisher",
