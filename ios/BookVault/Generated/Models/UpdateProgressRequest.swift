...
public struct UpdateProgressRequest: Sendable, Codable, JSONEncodable, Hashable {
    ...
    /** Optional client timestamp for conflict resolution */
    public var timestamp: Date?

    public init(bookId: UUID, positionSeconds: Double, timestamp: Date? = nil) {
        self.bookId = bookId
