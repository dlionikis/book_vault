...
- [🧪] **CarPlay (v1: browse + play)** - Scene, browse templates, Now Playing with chapter navigation ([plans/carplay-implementation-plan.md](archive/ios-phases/carplay-implementation-plan.md)) — **all code done** (PRs #145–#148, entitlement wired Aug 1); awaiting the manual CarPlay Simulator + head-unit passes. See below.
