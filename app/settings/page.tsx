      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            {/* Appearance */}
            <div id="appearance" className="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
              <h2 className="text-xl font-semibold text-gray-900 dark:text-white mb-4">
                Appearance
              </h2>
              <div className="space-y-4">
                <div>
                  ...
                  {mounted ? (
                    ...
                    <div className="flex gap-3">
                      <div className="flex-1 px-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-700 animate-pulse bg-gray-100 dark:bg-gray-800" />
                      <div className="flex-1 px-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-700 animate-pulse bg-gray-100 dark:bg-gray-800" />
                      <div className="flex-1 px-4 py-3 rounded-lg border-2 border-gray-200 dark:border-gray-700 animate-pulse bg-gray-100 dark:bg-gray-800" />
                    </div>
                  )}
